...
public class SetUserStatus implements HttpHandler {
    private static final Logger log = Logger.getLogger(SetUserStatus.class);
    public void handle(HttpExchange httpExchange) throws IOException {
        try {
                ...
                log.debug("start work handler\n body: " + rb);
                String response = UserStatusSetter.create(u1);
