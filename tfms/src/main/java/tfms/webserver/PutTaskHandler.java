...
public class PutTaskHandler implements HttpHandler {
    private static final Logger log = Logger.getLogger(PutTaskHandler.class);
    public void handle(HttpExchange httpExchange) throws IOException {
        try {
                ...
                log.debug("start work handler\n body: " + rb);
                String response =TaskDBCreator.create(t1);
